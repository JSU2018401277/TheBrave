			...
			<div class="lfnav fl">
				...
				<div class="subddzx">
					<ul>
						...
						<li><a href="done_order.html" >已完成的订单</a></li>
					</ul>
				</div>
			...
			<div id="usrinfo" class="rtcont fr">
                ...
                <table class="baseinfo edit-info">
                    <tr>
                        ...
                        <td>
<%--                            <p>用户名：<input type="text" v-model="userinfo.nickname"></p>--%>
<%--                            <p>性&emsp;别：--%>
<%--								<input type="radio" name="gender" v-model="userinfo.gender" value="male" />&nbsp;男&emsp;--%>
<%--								<input type="radio" name="gender" v-model="userinfo.gender" value="female" />&nbsp;女--%>
<%--							</p>--%>
                            <!--<p>手机号：<input type="text" v-bind:value="userinfos.phoneNum"></p>-->
	                        <span id="hint"></span>
                            <p>修改密码：<input type="password" name="birthday"  v-model="userinfo.birthday" id="userPassword" placeholder="请输入你的密码"></p>
                        </td>
                    </tr>
                    <tr>
						<td colspan="2"><a href="#" onclick="updateUser();" ><div class="save">确定</div></a></td>
                    </tr>
                </table>
			</div>
			<div class="clear"></div>
...
<%--                                    <div class="col-md-4">--%>
<%--                                        <div class="btn-group">--%>
<%--&lt;%&ndash;                                            <button class="btn btn-danger fa fa-undo" data-method="rotate" data-option="-90" type="button" title="Rotate -90 degrees"> 向左旋转</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <div class="btn-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                            <button class="btn  btn-danger fa fa-repeat" data-method="rotate" data-option="90" type="button" title="Rotate 90 degrees"> 向右旋转</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-5" style="text-align: right;">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <button class="btn btn-danger fa fa-arrows" data-method="setDragMode" data-option="move" type="button" title="移动">&ndash;%&gt;--%>
<%--&lt;%&ndash;								<span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="$().cropper(&quot;setDragMode&quot;, &quot;move&quot;)">&ndash;%&gt;--%>
<%--&lt;%&ndash;								</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <button type="button" class="btn btn-danger fa fa-search-plus" data-method="zoom" data-option="0.1" title="放大图片">&ndash;%&gt;--%>
<%--&lt;%&ndash;								<span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="$().cropper(&quot;zoom&quot;, 0.1)">&ndash;%&gt;--%>
<%--&lt;%&ndash;								  <!--<span class="fa fa-search-plus"></span>-->&ndash;%&gt;--%>
<%--&lt;%&ndash;								</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <button type="button" class="btn btn-danger fa fa-search-minus" data-method="zoom" data-option="-0.1" title="缩小图片">&ndash;%&gt;--%>
<%--&lt;%&ndash;								<span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="$().cropper(&quot;zoom&quot;, -0.1)">&ndash;%&gt;--%>
<%--&lt;%&ndash;								  <!--<span class="fa fa-search-minus"></span>-->&ndash;%&gt;--%>
<%--&lt;%&ndash;								</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <button type="button" class="btn btn-danger fa fa-refresh" data-method="reset" title="重置图片">&ndash;%&gt;--%>
<%--&lt;%&ndash;									        <span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="$().cropper(&quot;reset&quot;)" aria-describedby="tooltip866214"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </button>&ndash;%&gt;--%>
<%--                                    </div>--%>
<%--                                    <div class="col-md-3">--%>
