        ...
        <div id="usrinfo" class="rtcont fr">
            ...
            <table class="baseinfo edit-info">
                <tr>
                    ...
                    <td>
                        <p>&nbsp;商&nbsp;品&nbsp;名&nbsp;：<input type="text" v-model="userinfo.nickname" class="articleName"></p>
                        <p>商品介绍：<input type="text" name="birthday" id="datepicker" v-model="userinfo.birthday" class="articleIntro"></p>
                        <p>商品价格：<input type="text" v-bind:value="userinfos.phoneNum" class="articlePrice"></p>
                        <p>商品标签：<input type="text" name="birthday"  v-model="userinfo.birthday" class="articleLabel"></p>
                        <p>商品数量：<input type="text" name="birthday"  v-model="userinfo.birthday" class="articleNum"></p>
<%--                        <p>商品编号：<input type="text" name="birthday"  v-model="userinfo.birthday" class="articleId"></p>--%>
                ...
                <tr>
                    <td colspan="2">
                        <a href="#" >
                            <div class="save" onclick="addArticle();">确定</div></a></td>
                </tr>
            </table>
        </div>
        <div class="clear"></div>
